 ...
 * @author GL63
 */
public class StartServerSatu extends javax.swing.JFrame {

    /**
     * Creates new form StartServer
     */
    public StartServerSatu() {
        initComponents();
    }
        ...
        if (!jToggleButton1.isSelected()) // alternatively, (Boolean)getValue(Action.SELECTED_KEY)
    {
                 try {
                     ...
                     Logger.getLogger(StartServerSatu.class.getName()).log(Level.SEVERE, null, ex);
                 }
    }  
    else {
		...
		PemesananInterfaceDua ipemesanan2= (PemesananInterfaceDua) UnicastRemoteObject.exportObject(pemesanan2,0);
               ...
               try {
                   Naming.rebind(registryURL + "/pembeli",ipembeli);
                   Naming.rebind(registryURL + "/pesawat",ipesawat);
		Naming.rebind(registryURL + "/pemesanan",ipemesanan);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StartServerSatu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StartServerSatu().setVisible(true);
            }
        });
    }
